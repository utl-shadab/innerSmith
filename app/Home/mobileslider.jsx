...
const Mobileslider = () => {
  ...
  return (
    <section className="mobileSlider h-screen  bg-white relative overflow-hidden py-32 max-md:py-4 ">
      <div className="mobileSlider-content grid grid-cols-[65%_35%] h-full px-[7rem] max-md:grid-cols-1 max-md:px-[2rem] max-md:gap-[2rem] max-md:pt-[2rem]  ">
        <div className="mobileSlider-text flex relative  flex-col justify-center pt-[5rem] text-left h-full px-[7rem]  ">
          <h2 className="text-[#6AA7BB] capitalize text-[3.6rem]   max-md:text-[5rem]">
            Inside The App
          </h2>
          <p className="text-[#515151] text-[5.8rem] mt-10 font-[300] leading-[1.25] max-md:text-[3rem] pr-24">
